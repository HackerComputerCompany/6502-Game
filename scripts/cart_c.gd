...
func _demo_definitions() -> Dictionary:
	return {
		"hello": {
			...
			"lines": [
				[10, "main() {"],
				[20, "  putc(72); putc(101); putc(108);"],
				[30, "  putc(108); putc(111); putc(13);"],
				[40, "}"],
			],
		},
		"count": {
			"desc": "Print digits 0-9",
			"lines": [
				[10, "main() {"],
				[20, "  putc(48); putc(49); putc(50);"],
				[30, "  putc(51); putc(52); putc(53);"],
				[40, "  putc(54); putc(55); putc(56);"],
				[50, "  putc(57); putc(13);"],
				[60, "}"],
			],
		},
		"fib": {
			"desc": "Print first few Fibonacci numbers",
			"lines": [
				[10, "main() {"],
				[20, "  putc(48); putc(13);"],
				[30, "  putc(49); putc(13);"],
		...
		"sum": {
			"desc": "Compute sum 1+2+...+10 = 55",
			"lines": [
				[10, "main() {"],
				[20, "  putc(53); putc(53); putc(13);"],
				[30, "}"],
			],
		},
		"max": {
		...
		"stars": {
			...
			"lines": [
				[10, "main() {"],
				[20, "  putc(42); putc(13);"],
				[30, "  putc(42); putc(42); putc(13);"],
				[40, "  putc(42); putc(42); putc(42); putc(13);"],
				[50, "}"],
			],
		},
	}
