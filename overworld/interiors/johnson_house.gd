...
# Johnson House (10 wide x 8 tall)
# Simple house, living room + bedroom
...
const EXITS := {
	Vector2i(5, 7): {"map": "res://overworld/town_map.gd", "entry": "johnson_door"},
	Vector2i(6, 7): {"map": "res://overworld/town_map.gd", "entry": "johnson_door"},
}
...
func _build() -> void:
	...
	_window(0, 3)
	_window(9, 3)
	_wall(5, 0, 1, 3, Tile.WALL_GRAY)
	_door(5, 3)
	_furniture_block(1, 1, 3, 1)
	_furniture_block(2, 3, 2, 1)
	_furniture_block(7, 1, 2, 2)
