...
func _ready() -> void:
	...
	_background.color = Color(0, 0, 0, 0.55)
	_background.size = Vector2(210, 105)
	_background.position = Vector2(5, 5)
	...
	_title_label.position = Vector2(10, 7)
	_title_label.size = Vector2(200, 16)
	...
	_money_label.position = Vector2(10, 22)
	_money_label.size = Vector2(200, 18)
	...
	_time_label.position = Vector2(10, 38)
	_time_label.size = Vector2(200, 18)
	add_child(_time_label)

	_date_label = Label.new()
	_date_label.add_theme_color_override("font_color", Color(0.7, 0.7, 0.7))
	_date_label.add_theme_font_size_override("font_size", 10)
	_date_label.add_theme_color_override("font_outline_color", Color(0, 0, 0))
	_date_label.add_theme_constant_override("outline_size", 2)
	_date_label.position = Vector2(10, 54)
	_date_label.size = Vector2(200, 14)
	add_child(_date_label)

	_skills_label = Label.new()
	_skills_label.add_theme_color_override("font_color", Color(0.7, 0.7, 0.7))
	_skills_label.add_theme_font_size_override("font_size", 9)
	_skills_label.add_theme_color_override("font_outline_color", Color(0, 0, 0))
	_skills_label.add_theme_constant_override("outline_size", 2)
	_skills_label.position = Vector2(10, 68)
	_skills_label.size = Vector2(200, 35)
	add_child(_skills_label)

	_quest_label = Label.new()
	_quest_label.add_theme_color_override("font_color", Color(1, 0.8, 0.3))
	_quest_label.add_theme_font_size_override("font_size", 10)
	...
	_quest_label.position = Vector2(10, 88)
	_quest_label.size = Vector2(200, 16)
...
func _process(_delta: float) -> void:
	...
	if ps.current_quest != "":
		...
		_quest_label.visible = false
		_background.size = Vector2(210, 90)